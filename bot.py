...
async def get_content_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if content['content_type'] == ContentType.BATCH.value:
            ...
            reply_text += "```সাবধান  অনুগ্রহ করে এই ফাইলটি আপনার ব্যক্তিগত চ্যাট যেমন সংরক্ষিত বার্তা বা যেকোনো গ্রুপে ফরোয়ার্ড করুন।কিছুক্ষণ পরে ফাইলটি স্বয়ংক্রিয়ভাবে মুছে ফেলা হবে। Please Forward this file to your personal chat like saved message or any group.File will be Auto Deleted after few minutes```"
